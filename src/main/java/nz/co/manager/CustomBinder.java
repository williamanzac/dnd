...
import nz.co.manager.core.RandomService;
...
public final class CustomBinder extends AbstractBinder {
	...
	protected void configure() {
		...
		bind(CharacterAdvancementDAO.class).to(CharacterAdvancementDAO.class);
		...
		bind(RaceDAO.class).to(RaceDAO.class);
		...
		bind(SkillDAO.class).to(SkillDAO.class);
		...
		bind(CharacterAdvancementService.class).to(CharacterAdvancementService.class);
		...
		bind(RaceService.class).to(RaceService.class);
		...
		bind(SkillService.class).to(SkillService.class);
